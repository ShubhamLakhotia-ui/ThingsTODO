...
const Landing = () => {
  ...
  const fetchExclusiveExperiences = async () => {
    try {
      const response = await axios.get(
        `${API_BASE_URL}/thingstodo/get-all-images`
      );
  ...
  const handleAboutClick = () => {
    const exclusiveExperienceSection = document.getElementById(
  ...
  return (
    <div>
      ...
      <div
        className="bg-warning py-4 text-center"
        id="exclusiveExperienceSection"
      >
        <span style={{ fontWeight: "bold", fontSize: "30px" }}>
          Exclusive Experience by ThingsToDo
        </span>
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="section-header text-center pb-5">
                <h2>Our Services</h2>
                <p>
                  At the heart of every event management team is the event
                  manager, the mastermind behind the entire operation.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="card-body text-dark">
                    <div className="img-area mb-4">
                      <img
                        alt=""
                        className="img-fluid"
                        src={`data:image/png;base64,${service.image.data}`}
                      />
                    </div>
              ...
              <div className="card h-100 text-center">
                ...
                >
                  ...
                  <p className="card-text">
                    The creative director is the visionary responsible for
                    transforming ideas into tangible and awe-inspiring
                    realities. They infuse events with creativity and
                    innovation, crafting immersive environments that transport
                    attendees to different worlds.
                  </p>
            ...
            <div className="col">
              <div className="card h-100 text-center">
                ...
                >
                  ...
                  <p className="card-text">
                    Behind the scenes, a technical wizard ensures that the
                    audio, lighting, and video production aspects of a major
            ...
            <div className="col">
              <div className="card h-100 text-center">
                ...
                >
                  ...
                  <p className="card-text">
                    The venue serves as the canvas on which the event’s
                    narrative unfolds. The venue manager is responsible for
                    overseeing every aspect of the event space, ensuring that it
                    is transformed into a captivating setting.
                  </p>
                  <div className="socials">
                    <i className="bi bi-twitter text-dark mx-1"></i>
                    <i className="bi bi-facebook text-dark mx-1"></i>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3 footer-column ">
              <h5>Call Us On</h5>
              <p>857 381 7898</p>
              <a href="https://www.gmail.com" className="card-text">
