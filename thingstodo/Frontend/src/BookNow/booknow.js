...
const BookNow = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/booknow`, formData);
  ...
  return (
    <div>
      ...
      <div className="bg-warning" style={{ height: "100vh" }}>
        <section
          className="book-now section-padding"
          id="book-now"
            ...
            <div className="row justify-content-center align-items-center">
                ...
                <div className="card">
                  <div className="card-body">
                    <h2 className="card-title text-center">
                      Book <span className="text-warning">Now</span>
                    </h2>
              ...
              <div className="col-md-6">
                <div className="image-container">
                  <img
                    src={`data:image/png;base64,${location.state.image.data}`}
                    className="rounded mx-auto d-block smaller-image"
                    alt="Experience"
                  />
